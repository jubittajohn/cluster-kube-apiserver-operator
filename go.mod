...
replace (
	...
	github.com/openshift/api => github.com/jubittajohn/api v0.0.0-20260513162314-65cd93c67f06
	github.com/openshift/client-go => github.com/jubittajohn/client-go v0.0.0-20260513164646-5fd848300828
	github.com/openshift/library-go => github.com/jubittajohn/library-go v0.0.0-20260513165507-d7ade1bcd926
)
